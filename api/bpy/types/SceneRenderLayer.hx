package bpy.types;
@:pythonImport("bpy.types") extern class SceneRenderLayer extends Bpy_struct {
	/**
		Cycles SceneRenderLayer Settings
	**/
	public var cycles : CyclesRenderLayerSettings;
	/**
	...
	**/
	...
	public var freestyle_settings : FreestyleSettings;
	/**
	...
	**/
	public var pass_alpha_threshold : Float;
	/**
